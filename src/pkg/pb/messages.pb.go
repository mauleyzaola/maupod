...
var file_messages_proto_rawDesc = []byte{
	...
	0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x30, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x2a, 0xbe, 0x08, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x54, 0x45, 0x10, 0x12, 0x12, 0x0f, 0x0a, 0x0b, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x5f,
	...
	0x47, 0x45, 0x10, 0xf5, 0x03, 0x2a, 0x36, 0x0a, 0x0d, 0x4e, 0x61, 0x6d, 0x65, 0x64, 0x50, 0x6f,
...
var file_messages_proto_goTypes = []interface{}{
	...
	(*ScanDirectoryAudioFilesInput)(nil),   // 19: pb.ScanDirectoryAudioFilesInput
	(*SocketTrackPositionChangeInput)(nil), // 20: pb.SocketTrackPositionChangeInput
	(*SpectrumGenerateInput)(nil),          // 21: pb.SpectrumGenerateInput
	(*SpectrumGenerateOutput)(nil),         // 22: pb.SpectrumGenerateOutput
	(*TrackStartedInput)(nil),              // 23: pb.TrackStartedInput
	(*TrackEndedInput)(nil),                // 24: pb.TrackEndedInput
	(*TrackPlayedInput)(nil),               // 25: pb.TrackPlayedInput
	(*TrackPositionInput)(nil),             // 26: pb.TrackPositionInput
	(*TrackSkippedInput)(nil),              // 27: pb.TrackSkippedInput
	(*Media)(nil),                          // 28: pb.Media
	(*timestamp.Timestamp)(nil),            // 29: google.protobuf.Timestamp
}
var file_messages_proto_depIdxs = []int32{
	28, // 0: pb.ArtworkExtractInput.media:type_name -> pb.Media
	29, // 1: pb.ArtworkExtractInput.scan_date:type_name -> google.protobuf.Timestamp
	28, // 2: pb.ArtworkUpdateInput.media:type_name -> pb.Media
	9,  // 3: pb.DirectoryReadOutput.files:type_name -> pb.FileItem
	28, // 4: pb.IPCInput.media:type_name -> pb.Media
	0,  // 5: pb.IPCInput.command:type_name -> pb.Message
	28, // 6: pb.MediaInfoInput.media:type_name -> pb.Media
	28, // 7: pb.MediaInfoOutput.media:type_name -> pb.Media
	18, // 8: pb.MediaInfoOutput.response:type_name -> pb.Response
	29, // 9: pb.MediaInfoOutput.last_modified_date:type_name -> google.protobuf.Timestamp
	28, // 10: pb.Queue.media:type_name -> pb.Media
	28, // 11: pb.QueueInput.media:type_name -> pb.Media
	1,  // 12: pb.QueueInput.named_position:type_name -> pb.NamedPosition
	15, // 13: pb.QueueOutput.rows:type_name -> pb.Queue
	29, // 14: pb.ScanDirectoryAudioFilesInput.scan_date:type_name -> google.protobuf.Timestamp
	28, // 15: pb.SocketTrackPositionChangeInput.media:type_name -> pb.Media
	28, // 16: pb.SpectrumGenerateInput.media:type_name -> pb.Media
	28, // 17: pb.SpectrumGenerateOutput.media:type_name -> pb.Media
	28, // 18: pb.TrackStartedInput.media:type_name -> pb.Media
	29, // 19: pb.TrackStartedInput.timestamp:type_name -> google.protobuf.Timestamp
	28, // 20: pb.TrackEndedInput.media:type_name -> pb.Media
	29, // 21: pb.TrackEndedInput.timestamp:type_name -> google.protobuf.Timestamp
	28, // 22: pb.TrackPlayedInput.media:type_name -> pb.Media
	29, // 23: pb.TrackPlayedInput.timestamp:type_name -> google.protobuf.Timestamp
	28, // 24: pb.TrackPositionInput.media:type_name -> pb.Media
	28, // 25: pb.TrackSkippedInput.media:type_name -> pb.Media
	29, // 26: pb.TrackSkippedInput.timestamp:type_name -> google.protobuf.Timestamp
