...
var file_messages_proto_rawDesc = []byte{
	...
	0x0e, 0x53, 0x79, 0x6e, 0x63, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12,
	0x29, 0x0a, 0x10, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x27, 0x0a, 0x0f, 0x53, 0x79,
	0x6e, 0x63, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x14, 0x0a,
	...
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x2a, 0xc6, 0x0a, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0c, 0x0a, 0x08,
	...
	0x49, 0x41, 0x5f, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x10, 0x15, 0x12, 0x24, 0x0a, 0x20, 0x4d, 0x45,
	0x53, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x41, 0x52, 0x54, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x46, 0x49,
	0x4e, 0x44, 0x5f, 0x41, 0x4c, 0x42, 0x55, 0x4d, 0x5f, 0x43, 0x4f, 0x56, 0x45, 0x52, 0x10, 0x16,
	0x12, 0x1c, 0x0a, 0x18, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x41, 0x52, 0x54, 0x57,
	0x4f, 0x52, 0x4b, 0x5f, 0x44, 0x4f, 0x57, 0x4e, 0x4c, 0x4f, 0x41, 0x44, 0x10, 0x17, 0x12, 0x16,
	0x0a, 0x12, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x5f, 0x53, 0x59, 0x4e, 0x43, 0x5f, 0x46,
	0x49, 0x4c, 0x45, 0x53, 0x10, 0x18, 0x12, 0x0f, 0x0a, 0x0b, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47,
...
var file_messages_proto_goTypes = []interface{}{
	...
	(*SyncFilesInput)(nil),                 // 29: pb.SyncFilesInput
	(*SyncFilesOutput)(nil),                // 30: pb.SyncFilesOutput
	(*TrackStartedInput)(nil),              // 31: pb.TrackStartedInput
	(*TrackEndedInput)(nil),                // 32: pb.TrackEndedInput
	(*TrackPlayedInput)(nil),               // 33: pb.TrackPlayedInput
	(*TrackPositionInput)(nil),             // 34: pb.TrackPositionInput
	(*TrackSkippedInput)(nil),              // 35: pb.TrackSkippedInput
	(*Media)(nil),                          // 36: pb.Media
	(*timestamp.Timestamp)(nil),            // 37: google.protobuf.Timestamp
}
var file_messages_proto_depIdxs = []int32{
	36, // 0: pb.ArtworkExtractInput.media:type_name -> pb.Media
	37, // 1: pb.ArtworkExtractInput.scan_date:type_name -> google.protobuf.Timestamp
	36, // 2: pb.ArtworkUpdateInput.media:type_name -> pb.Media
	11, // 3: pb.DirectoryReadOutput.files:type_name -> pb.FileItem
	36, // 4: pb.IPCInput.media:type_name -> pb.Media
	0,  // 5: pb.IPCInput.command:type_name -> pb.Message
	37, // 6: pb.MediaEventInput.ts:type_name -> google.protobuf.Timestamp
	0,  // 7: pb.MediaEventInput.event:type_name -> pb.Message
	36, // 8: pb.MediaInfoInput.media:type_name -> pb.Media
	36, // 9: pb.MediaInfoOutput.media:type_name -> pb.Media
	24, // 10: pb.MediaInfoOutput.response:type_name -> pb.Response
	37, // 11: pb.MediaInfoOutput.last_modified_date:type_name -> google.protobuf.Timestamp
	36, // 12: pb.MediaInfosOutput.medias:type_name -> pb.Media
	24, // 13: pb.MediaInfosOutput.response:type_name -> pb.Response
	36, // 14: pb.PlayTrackInput.media:type_name -> pb.Media
	36, // 15: pb.Queue.media:type_name -> pb.Media
	36, // 16: pb.QueueInput.media:type_name -> pb.Media
	1,  // 17: pb.QueueInput.named_position:type_name -> pb.NamedPosition
	20, // 18: pb.QueueOutput.rows:type_name -> pb.Queue
	37, // 19: pb.ScanDirectoryAudioFilesInput.scan_date:type_name -> google.protobuf.Timestamp
	36, // 20: pb.SocketTrackPositionChangeInput.media:type_name -> pb.Media
	36, // 21: pb.SpectrumGenerateInput.media:type_name -> pb.Media
	36, // 22: pb.SpectrumGenerateOutput.media:type_name -> pb.Media
	36, // 23: pb.TrackStartedInput.media:type_name -> pb.Media
	37, // 24: pb.TrackStartedInput.timestamp:type_name -> google.protobuf.Timestamp
	36, // 25: pb.TrackEndedInput.media:type_name -> pb.Media
	37, // 26: pb.TrackEndedInput.timestamp:type_name -> google.protobuf.Timestamp
	36, // 27: pb.TrackPlayedInput.media:type_name -> pb.Media
	37, // 28: pb.TrackPlayedInput.timestamp:type_name -> google.protobuf.Timestamp
	36, // 29: pb.TrackPositionInput.media:type_name -> pb.Media
	36, // 30: pb.TrackSkippedInput.media:type_name -> pb.Media
	37, // 31: pb.TrackSkippedInput.timestamp:type_name -> google.protobuf.Timestamp
