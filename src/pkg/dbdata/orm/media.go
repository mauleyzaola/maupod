...
type Medium struct {
	...
	Directory             string    `boil:"directory" json:"directory" toml:"directory" yaml:"directory"`
...
var MediumWhere = struct {
	...
	Directory:             whereHelperstring{field: "\"media\".\"directory\""},
