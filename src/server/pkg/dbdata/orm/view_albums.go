...
type ViewAlbum struct {
	...
	BitRate         types.NullDecimal `boil:"bit_rate" json:"bit_rate,omitempty" toml:"bit_rate" yaml:"bit_rate,omitempty"`
	...
	SamplingRate    types.NullDecimal `boil:"sampling_rate" json:"sampling_rate,omitempty" toml:"sampling_rate" yaml:"sampling_rate,omitempty"`
...
var ViewAlbumWhere = struct {
	...
	BitRate:         whereHelpertypes_NullDecimal{field: "\"view_albums\".\"bit_rate\""},
	...
	SamplingRate:    whereHelpertypes_NullDecimal{field: "\"view_albums\".\"sampling_rate\""},
...
var (
	viewAlbumAllColumns            = []string{"id", "album_identifier", "album", "duration", "bit_rate", "performer", "genre", "recorded_date", "sampling_rate", "track_name_total", "sha_image"}
	viewAlbumColumnsWithoutDefault = []string{"id", "album_identifier", "album", "duration", "bit_rate", "performer", "genre", "recorded_date", "sampling_rate", "track_name_total", "sha_image"}
