...
var file_messages_proto_rawDesc = []byte{
	...
	0x69, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x65,
	0x64, 0x69, 0x61, 0x52, 0x05, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x22, 0x4e, 0x0a, 0x0e, 0x4d, 0x65,
	...
	0x74, 0x65, 0x2a, 0xa6, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18,
	...
	0x49, 0x41, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x05, 0x42, 0x2d, 0x5a, 0x2b, 0x67,
...
var file_messages_proto_goTypes = []interface{}{
	...
	(*ArtworkUpdateInput)(nil),           // 2: pb.ArtworkUpdateInput
	(*MediaInfoInput)(nil),               // 3: pb.MediaInfoInput
	(*MediaInfoOutput)(nil),              // 4: pb.MediaInfoOutput
	(*Response)(nil),                     // 5: pb.Response
	(*ScanDirectoryAudioFilesInput)(nil), // 6: pb.ScanDirectoryAudioFilesInput
	(*Media)(nil),                        // 7: pb.Media
	(*timestamp.Timestamp)(nil),          // 8: google.protobuf.Timestamp
}
var file_messages_proto_depIdxs = []int32{
	7, // 0: pb.ArtworkExtractInput.media:type_name -> pb.Media
	8, // 1: pb.ArtworkExtractInput.scan_date:type_name -> google.protobuf.Timestamp
	7, // 2: pb.ArtworkUpdateInput.media:type_name -> pb.Media
	7, // 3: pb.MediaInfoInput.media:type_name -> pb.Media
	7, // 4: pb.MediaInfoOutput.media:type_name -> pb.Media
	5, // 5: pb.MediaInfoOutput.response:type_name -> pb.Response
	8, // 6: pb.MediaInfoOutput.last_modified_date:type_name -> google.protobuf.Timestamp
	8, // 7: pb.ScanDirectoryAudioFilesInput.scan_date:type_name -> google.protobuf.Timestamp
